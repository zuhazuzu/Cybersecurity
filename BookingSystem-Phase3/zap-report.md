...
* URL: http://localhost:8000/reservation%3Fid=6
  * Method: `GET`
  * Parameter: ``
  * Attack: ``
  * Evidence: `username`
...
localhost
csrf_token=8676e696-6df3-4992-b0f9-5844a6c78b8e
`
...
* URL: http://localhost:8000/register
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=91bc20fd-1b5f-481e-8402-e232c7c6c495
`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
csrf_token=f144cf56-04ad-4af0-8946-be71c0fd912f
`
* URL: http://localhost:8000/register
  * Method: `POST`
  * Parameter: ``
  ...
  * Other Info: `The origin domain used for comparison was:
localhost
session_id=5772198c-80b5-4120-b6fe-2100c4274f62
`
...
* URL: http://localhost:8000/login
  ...
  * Attack: ``
  * Evidence: `8676e696-6df3-4992-b0f9-5844a6c78b8e`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `91bc20fd-1b5f-481e-8402-e232c7c6c495`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `GET`
  * Parameter: `csrf_token`
  * Attack: ``
  * Evidence: `f144cf56-04ad-4af0-8946-be71c0fd912f`
  * Other Info: `
cookie:csrf_token`
* URL: http://localhost:8000/register
  * Method: `POST`
  ...
  * Attack: ``
  * Evidence: `5772198c-80b5-4120-b6fe-2100c4274f62`
  * Other Info: `
cookie:session_id`
...
* URL: http://localhost:8000/api/resources/2
  ...
  * Evidence: ``
  * Other Info: ``
* URL: http://localhost:8000/api/resources/5
  * Method: `GET`
  * Parameter: `Header User-Agent`
  * Attack: `Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1)`
  * Evidence: ``
